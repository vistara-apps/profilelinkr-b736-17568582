...
/**
 * Generate dynamic OpenGraph images for profiles
 * This endpoint creates custom images for social sharing and frames
 */
export async function GET(req: NextRequest) {
  try {
    ...
    // If no username is provided, return a default image
    if (!username) {
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {shared ? 'View Profile' : 'Share Profile'}
              </div>
            </div>
            <div
              style={{
